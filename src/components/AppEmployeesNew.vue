        ...
        chekIssuedBy(value, index) {
            if ( value != null ) {
                ...
                let arrFilter = arr.filter(function(item) {
                    ...
                    return ( (item != 'Р-ОН' ) && (item != 'ОБЛ.') && (item != 'Д.') && (item != 'ДЕР.') && (item != 'ИМ.') && (item != 'ДЕТ.') && (item != 'СТ.') && (item != 'РЕСПУБ.') && (item != 'РЕСП.') && (item != 'Р.') && (item != 'Р-НЕ') && (item != 'Р-НА') && (item != 'С.') && (item != 'ПОС.') && (item != 'П.') && (item != 'Г.') && (item != 'ГОР.') && (item != 'Р.')) 
                })
