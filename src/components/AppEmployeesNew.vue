                ...
                <div class="mo-body">
                    <div class="individual">
                        ...
                        <div class="individual-wrap">
                            ...
                            <div class="btn-wrap">
                                <button class="btn-clear" @click="onward()">Сохранить</button>
        ...
        chekIssuedBy(value, index) {
            if ( value != null ) {
                ...
                let arrFilter = arr.filter(function(item) {
                    ...
                    return ( (item != 'АВТ.' ) && (item != 'ОКР.' ) && (item != 'Р-ОН' ) && (item != 'ОБЛ.') && (item != 'Д.') && (item != 'ДЕР.') && (item != 'ИМ.') && (item != 'ДЕТ.') && (item != 'СТ.') && (item != 'РЕСПУБ.') && (item != 'РЕСП.') && (item != 'Р.') && (item != 'Р-НЕ') && (item != 'Р-НА') && (item != 'С.') && (item != 'ПОС.') && (item != 'П.') && (item != 'Г.') && (item != 'ГОР.') && (item != 'Р.')) 
                })
